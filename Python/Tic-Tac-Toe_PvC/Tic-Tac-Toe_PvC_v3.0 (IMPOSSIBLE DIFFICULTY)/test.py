...
def function():
    ...
    matrix = [[0, 0, 0],
              [0, 0, 0],
              [0, 0, 0]]
    print('Select who to start the game:\n1)%s%s%s\n2)%sComputer%s\n3)%sRan%sdom%s' % (blue, name, white, red, white, blue, red, white))
    ...
    if turn is 1:
        type(matrix)
        print("*%s%s's turn%s*" % (blue, name, white))
        l = int(input('-line: \x1b[1;34;40m'))
        print('%s' % white, end = "")
        while l < 1 or l > 3:
            print('%sLine index out of range%s%s!\n-line: ' % (und, eund, white), end = "")
            l = int(input('\x1b[1;34;40m'))
            print('%s' % white, end = "")
        l -= 1
        c = int(input('-column: \x1b[1;34;40m'))
        print('%s' % white, end = "")
        while c < 1 or c > 3:
            print('%sColumn index out of range%s%s!\n-column: ' % (und, eund, white), end = "")
            c = int(input('\x1b[1;34;40m'))
            print('%s' % white, end = "")
        c -= 1
        matrix[l][c] = 1
...
try:
    ...
    sts = [0, 0, 0, 0]
print('%s' % white, end = "")
name = input('Enter your name here: \x1b[1;34;40m')
print('\n%sRules:%s\n%s = X%s\n%s = 0%s' % (white, red, 'Computer', blue, name, white), end = "\n\n")
function()
